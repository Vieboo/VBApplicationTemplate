...
public abstract class BaseRetrofitHelper {
    ...
    public BaseRetrofitHelper(Application app) {
        this.app = app;
        initOkHttp();
    }
...
//        builder.addInterceptor(apikey);
        ...
        builder.cache(cache);
        //设置超时
        builder.connectTimeout(getTimeOutSeconds(), TimeUnit.SECONDS);
        builder.readTimeout(getTimeOutSeconds(), TimeUnit.SECONDS);
        builder.writeTimeout(getTimeOutSeconds(), TimeUnit.SECONDS);
        //错误重连
